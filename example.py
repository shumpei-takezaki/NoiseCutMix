...
if __name__ == "__main__":
    ...
    parser.add_argument("--num_gen", type=int, default=8, help="number of generated images per class")
    ...
    images, _, mask = generator(target_labels=target_labels, return_mask=True)
